...
const items = await client.Detokenize().list({ bfid: "example" })
```
...
| Lean | `voxgig-sdk-bluefin-shieldconex` | publish pending — [install from git tag](https://github.com/voxgig-sdk/bluefin-shieldconex-sdk/releases) |
