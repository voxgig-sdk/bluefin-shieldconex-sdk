# BluefinShieldconex SDK Validate entity
...
# Returns the current Validate data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of Validate fields).
sub match_get {
  my ($self) = @_;
...
#
# reqdata: body data hashref (ValidateCreateData shape). ctrl: optional
# per-call control. Returns the created Validate data (hashref); dies
