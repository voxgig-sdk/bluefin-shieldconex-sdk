...
#      (BluefinShieldconexSDK->test) against the real SDK. Captured output is scanned for
...
my $SDK_CLASS = 'BluefinShieldconexSDK';
...
# becomes BluefinShieldconexSDK->test(<fixtures>); a block that only uses $client gets
