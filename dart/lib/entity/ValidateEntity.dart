...
// Typed models: see ../BluefinShieldconexTypes.dart (Validate and the per-op request/match types).
class ValidateEntity extends BluefinShieldconexEntityBase {
  ValidateEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'validate';
    name_ = 'validate';
    Name = 'Validate';
  }
  ...
  ValidateEntity make() {
    return ValidateEntity(client, entopts());
  }




  /// Create a Validate (see ValidateCreateData in
  /// BluefinShieldconexTypes.dart). Returns the entity data map (Validate).
