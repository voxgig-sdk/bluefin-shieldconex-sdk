...
// Typed models: see ../BluefinShieldconexTypes.dart (TokenizeRead and the per-op request/match types).
class TokenizeReadEntity extends BluefinShieldconexEntityBase {
  TokenizeReadEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'tokenize_read';
    name_ = 'tokenize_read';
    Name = 'TokenizeRead';
  }

  TokenizeReadEntity make() {
    return TokenizeReadEntity(client, entopts());
  }




  /// Create a TokenizeRead (see TokenizeReadCreateData in
  /// BluefinShieldconexTypes.dart). Returns the entity data map (TokenizeRead).
