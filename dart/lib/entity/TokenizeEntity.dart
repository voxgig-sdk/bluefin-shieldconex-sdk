...
// Typed models: see ../BluefinShieldconexTypes.dart (Tokenize and the per-op request/match types).
class TokenizeEntity extends BluefinShieldconexEntityBase {
  TokenizeEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'tokenize';
    name_ = 'tokenize';
    Name = 'Tokenize';
  }
  ...
  TokenizeEntity make() {
    return TokenizeEntity(client, entopts());
  }



  /// List Tokenize entities by match (see TokenizeListMatch in
  /// BluefinShieldconexTypes.dart). Returns a list of Tokenize entity instances.
  ...
  /// Create a Tokenize (see TokenizeCreateData in
  /// BluefinShieldconexTypes.dart). Returns the entity data map (Tokenize).
