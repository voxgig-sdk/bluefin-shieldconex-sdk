...
// Typed models: see ../BluefinShieldconexTypes.dart (Detokenize and the per-op request/match types).
class DetokenizeEntity extends BluefinShieldconexEntityBase {
  DetokenizeEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'detokenize';
    name_ = 'detokenize';
    Name = 'Detokenize';
  }

  DetokenizeEntity make() {
    return DetokenizeEntity(client, entopts());
  }



  /// List Detokenize entities by match (see DetokenizeListMatch in
  /// BluefinShieldconexTypes.dart). Returns a list of Detokenize entity instances.
  ...
  /// Create a Detokenize (see DetokenizeCreateData in
  /// BluefinShieldconexTypes.dart). Returns the entity data map (Detokenize).
