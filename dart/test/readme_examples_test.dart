// BluefinShieldconex SDK — documentation dart-examples presence & completeness gate.
...
const String _sdkClass = 'BluefinShieldconexSDK';

// The API's capitalised semantic entities, used to spot a client.<Entity>()
// factory call inside a block.
const List<String> _entities = <String>['Detokenize', 'Tokenize', 'TokenizeBatch', 'TokenizeRead', 'Validate'];
