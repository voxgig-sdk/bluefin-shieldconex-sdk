...
void tests() {
  describe('TokenizeEntity', () {
    ...
    test('stream', (t) async {
      ...
      final plainent = plainsdk.Tokenize();
      final seen2 = [];
    ...
    test('basic', (t) async {
      ...
      for (final op in ['create', 'list']) {
        if (maybeSkipControl(t, 'entityOp', 'tokenize.' + op, live)) {
          return;
        }
      }
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['tokenize01', 'tokenize02', 'tokenize03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_SHIELDCONEX_TEST_TOKENIZE_ENTID'];
