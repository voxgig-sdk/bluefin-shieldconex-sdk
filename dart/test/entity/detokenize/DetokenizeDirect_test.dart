...
void tests() {
  describe('DetokenizeDirect', () {
    ...
    test('direct-list-detokenize', (t) async {
      final setup = directSetup([
        {'id': 'direct01'},
        {'id': 'direct02'}
      ]);
      if (maybeSkipControl(
          t, 'direct', 'direct-list-detokenize', true == setup['live'])) {
        return;
      }
...
Map<String, dynamic> directSetup([dynamic mockres]) {
  ...
  final env = envOverride({
    'BLUEFINSHIELDCONEX_TEST_DETOKENIZE_ENTID': <String, dynamic>{},
  ...
  if (live) {
    ...
    dynamic idmap = env['BLUEFINSHIELDCONEX_TEST_DETOKENIZE_ENTID'];
