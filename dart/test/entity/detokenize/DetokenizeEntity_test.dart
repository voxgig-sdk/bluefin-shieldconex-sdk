...
void tests() {
  describe('DetokenizeEntity', () {
    ...
    test('stream', (t) async {
      ...
      final plainent = plainsdk.Detokenize();
      final seen2 = [];
    ...
    test('basic', (t) async {
      ...
      for (final op in ['create', 'list']) {
        if (maybeSkipControl(t, 'entityOp', 'detokenize.' + op, live)) {
          return;
        }
      }
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['detokenize01', 'detokenize02', 'detokenize03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_SHIELDCONEX_TEST_DETOKENIZE_ENTID'];
