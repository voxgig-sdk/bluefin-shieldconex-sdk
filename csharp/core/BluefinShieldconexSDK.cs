...
using BluefinShieldconexSdk.Feature;

namespace BluefinShieldconexSdk;

public class BluefinShieldconexSDK
{
    ...
    public BluefinShieldconexSDK(Dictionary<string, object?>? options = null)
    {
        ...
        var config = global::BluefinShieldconexSdk.SdkConfig.SharedConfig();
        ...
        // the chain.
        var featureOpts = global::BluefinShieldconexSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(_options, "feature"))
        ...
        foreach (var fnameObj in featureOrder)
        {
            ...
            var fopts = global::BluefinShieldconexSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(featureOpts, fname));
            if (fopts != null &&
                fopts.TryGetValue("active", out var active) &&
                active is bool ab && ab)
            {
                _utility.FeatureAdd(_rootctx, global::BluefinShieldconexSdk.SdkConfig.MakeFeature(fname));
            }
        }
    ...
    {
        return global::BluefinShieldconexSdk.Utility.Copy(_utility);
    }
    ...
    public Dictionary<string, object?> Prepare(Dictionary<string, object?>? fetchargs)
    {
        ...
        var ctrl = global::BluefinShieldconexSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "ctrl"))
            ?? new Dictionary<string, object?>();
        ...
        var pathParams = global::BluefinShieldconexSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "params"))
            ?? new Dictionary<string, object?>();
        var query = global::BluefinShieldconexSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "query"))
            ?? new Dictionary<string, object?>();
    ...
    private Dictionary<string, object?> OpDenied(string op)
    {
        ...
        {
            ["ok"] = false,
            ["err"] = new Exception("BluefinShieldconexSDK: " + op +
    ...
    private Dictionary<string, object?> RawRequest(Dictionary<string, object?>? fetchargs)
    {
        ...
        {
            var status = global::BluefinShieldconexSdk.Helpers.ToInt(global::Voxgig.Struct.StructUtils.GetProp(fm, "status"));
        ...
        Dictionary<string, object?>? ctrl = null)
    {
        ...
        if (null != errors && 0 < errors.Count)
        {
            ...
            res["ok"] = false;
            res["err"] = new Exception("BluefinShieldconexSDK: graphql: " + msg);
            res["graphql"] = errors;
        }
    ...
    // Idiomatic usage: client.Detokenize().List(null) or
    // client.Detokenize().Load(new() { ["id"] = ... }).
    public BluefinShieldconexEntityBase Detokenize(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinShieldconexSdk.Entity.DetokenizeEntity(this, entopts);
    }

    // Tokenize returns a Tokenize entity bound to this client.
    // Idiomatic usage: client.Tokenize().List(null) or
    // client.Tokenize().Load(new() { ["id"] = ... }).
    public BluefinShieldconexEntityBase Tokenize(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinShieldconexSdk.Entity.TokenizeEntity(this, entopts);
    }

    // TokenizeBatch returns a TokenizeBatch entity bound to this client.
    // Idiomatic usage: client.TokenizeBatch().List(null) or
    // client.TokenizeBatch().Load(new() { ["id"] = ... }).
    public BluefinShieldconexEntityBase TokenizeBatch(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinShieldconexSdk.Entity.TokenizeBatchEntity(this, entopts);
    }

    // TokenizeRead returns a TokenizeRead entity bound to this client.
    // Idiomatic usage: client.TokenizeRead().List(null) or
    // client.TokenizeRead().Load(new() { ["id"] = ... }).
    public BluefinShieldconexEntityBase TokenizeRead(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinShieldconexSdk.Entity.TokenizeReadEntity(this, entopts);
    }

    // Validate returns a Validate entity bound to this client.
    // Idiomatic usage: client.Validate().List(null) or
    // client.Validate().Load(new() { ["id"] = ... }).
    public BluefinShieldconexEntityBase Validate(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinShieldconexSdk.Entity.ValidateEntity(this, entopts);
    }


    public static BluefinShieldconexSDK TestSDK(Dictionary<string, object?>? testopts,
        Dictionary<string, object?>? sdkopts)
    {
        ...
        var sdk = new BluefinShieldconexSDK(sdkopts)
        {
            Mode = "test",
        };
