...
public abstract class BluefinShieldconexEntityBase : IEntity
{
    protected string name;
    protected BluefinShieldconexSDK client;
    ...
    protected BluefinShieldconexEntityBase(BluefinShieldconexSDK client,
