...
internal static class Fh
{
    ...
    {
        return err is BluefinShieldconexError se ? se.Code : "";
    }
}
...
public class FeaturePagingTest
{
    ...
    public void StampsPageLimitAndReadsHeaders()
    {
        ...
        Assert.Equal(2, BluefinShieldconexSdk.Helpers.ToInt(paging["nextPage"]));
        Assert.Equal(5, BluefinShieldconexSdk.Helpers.ToInt(paging["totalCount"]));
