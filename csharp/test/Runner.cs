// BluefinShieldconex SDK test-runner SUPPORT (vendor-tag rollout): env overrides,
...
public static class TestRunner
{
    ...
    {
        if (Environment.GetEnvironmentVariable("BLUEFIN_SHIELDCONEX_TEST_LIVE") == "TRUE" ||
            Environment.GetEnvironmentVariable("BLUEFIN_SHIELDCONEX_TEST_OVERRIDE") == "TRUE")
        {
        ...
        var explain = Environment.GetEnvironmentVariable("BLUEFIN_SHIELDCONEX_TEST_EXPLAIN");
    ...
    public static int LiveDelayMs()
    {
        ...
        {
            var n = BluefinShieldconexSdk.Helpers.ToInt(v);
            if (n >= 0)
            {
                return n;
            }
    ...
    public static Context MakeCtxFromMap(Dictionary<string, object?>? ctxmap,
        BluefinShieldconexSDK? client, Utility? utility)
    {
            ...
            resRaw is Dictionary<string, object?> resMap)
        {
            ...
            {
                ctx.Result.Err = new BluefinShieldconexError("", msg, null);
            }
        }
    ...
    public static void FixCtx(Context ctx, BluefinShieldconexSDK client)
    {
    ...
    public static Exception? ErrFromMap(Dictionary<string, object?>? m)
    {
        ...
        return new BluefinShieldconexError(code, msg, null);
    }
