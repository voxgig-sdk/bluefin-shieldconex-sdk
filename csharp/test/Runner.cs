...
public static class TestRunner
{
    ...
    {
        if (Environment.GetEnvironmentVariable("BLUEFINSHIELDCONEX_TEST_LIVE") == "TRUE" ||
            Environment.GetEnvironmentVariable("BLUEFINSHIELDCONEX_TEST_OVERRIDE") == "TRUE")
        {
        ...
        var explain = Environment.GetEnvironmentVariable("BLUEFINSHIELDCONEX_TEST_EXPLAIN");
