// detokenize direct API tests (generated from the API model).
...
public class DetokenizeDirectTest
{
    ...
    {
        var setup = DetokenizeDirectSetup(new List<object?>
        {
        ...
        var (_shouldSkip, _) = TestRunner.IsControlSkipped(
            "direct", "direct-list-detokenize", _mode);
        if (_shouldSkip)
        {
    ...
    private class DetokenizeDirectSetupResult
    {
    ...
    private static DetokenizeDirectSetupResult DetokenizeDirectSetup(object? mockres)
    {
        ...
        {
            ["BLUEFINSHIELDCONEX_TEST_DETOKENIZE_ENTID"] = new Dictionary<string, object?>(),
        ...
        if (live)
        {
            ...
            var entidRaw = env["BLUEFINSHIELDCONEX_TEST_DETOKENIZE_ENTID"];
            ...
            return new DetokenizeDirectSetupResult
            {
                Client = liveClient,
                Calls = calls,
                Live = true,
