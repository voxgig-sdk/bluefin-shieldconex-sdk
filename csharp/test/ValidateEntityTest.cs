...
public class ValidateEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_SHIELDCONEX_TEST_VALIDATE_ENTID JSON to run live.
        ...
        validateRef01Data = Helpers.ToMapAny(validateRef01DataResult is IEntity ce ? ce.Data() : validateRef01DataResult);
