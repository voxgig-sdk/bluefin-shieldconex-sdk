...
public class PrimaryUtilityTest
{
    ...
    private readonly BluefinShieldconexSDK _client;
    ...
    public PrimaryUtilityTest()
    {
        ...
        _client = BluefinShieldconexSDK.TestSDK(null, null);
        _utility = _client.GetUtility();
    }

    // Helper: create basic test context.
    private Context MakeTestCtx(BluefinShieldconexSDK client, Utility utility,
    ...
    private Context MakeTestFullCtx(BluefinShieldconexSDK client, Utility utility)
    {
