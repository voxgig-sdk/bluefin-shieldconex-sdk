...
public class TokenizeBatchEntityTest
{
    ...
    public void Basic()
    {
        ...
        // and 4xx; set BLUEFIN_SHIELDCONEX_TEST_TOKENIZE_BATCH_ENTID JSON to run live.
        ...
        tokenizeBatchRef01Data = Helpers.ToMapAny(tokenizeBatchRef01DataResult is IEntity ce ? ce.Data() : tokenizeBatchRef01DataResult);
