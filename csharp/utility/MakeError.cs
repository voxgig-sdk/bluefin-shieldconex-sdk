// BluefinShieldconex SDK utility: makeError - the single error surface of the
// pipeline. Throws the wrapped BluefinShieldconexError unless the per-call ctrl
// disables throwing (ctrl.throw == false), in which case it returns the
// (possibly nil) result data instead.

namespace BluefinShieldconexSdk.Util;
...
public static partial class SdkUtility
{
    internal static object? MakeErrorUtil(Context ctx, Exception? err)
    {
        ...
        var msg = "BluefinShieldconexSDK: " + opname + ": " + errmsg;
        ...
        var sdkErr = new BluefinShieldconexError(
            err is BluefinShieldconexError se ? se.Code : "", msg, ctx)
        {
