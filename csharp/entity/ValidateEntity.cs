...
public class ValidateEntity : BluefinShieldconexEntityBase
{
    public ValidateEntity(BluefinShieldconexSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "validate")
    {
    }

    public override IEntity Make()
    {
        return new ValidateEntity(client, CloneOpts());
    }
