...
public class TokenizeEntity : BluefinShieldconexEntityBase
{
    public TokenizeEntity(BluefinShieldconexSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "tokenize")
    {
    }

    public override IEntity Make()
    {
        return new TokenizeEntity(client, CloneOpts());
    }
