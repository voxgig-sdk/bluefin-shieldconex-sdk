# BluefinShieldconex PHP SDK



The PHP SDK for the BluefinShieldconex API — an entity-oriented client using PHP conventions.
...
```php
// list() returns an array of Detokenize records (throws on error).
$detokenizes = $client->Detokenize()->list();
```
...
```
php/
├── bluefinshieldconex_sdk.php          -- Main SDK class
...
The main class (`bluefinshieldconex_sdk.php`) exports the SDK class
