...
class DetokenizeDirectTest extends TestCase
{
    public function test_direct_list_detokenize(): void
    {
        $setup = detokenize_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-detokenize", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
