...
// BluefinShieldconex SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BluefinShieldconexSDK::test)
...
{
    private const SDK_CLASS = 'BluefinShieldconexSDK';
    ...
    private const SDK_BASE = 'bluefinshieldconex_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../bluefinshieldconex_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
