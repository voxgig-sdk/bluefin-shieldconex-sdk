...
class TokenizeReadEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TokenizeReadEntity($this->_client, $opts);
    }

    /**
     * @param TokenizeRead|array $args TokenizeRead data (assoc-array) to store.
     */
    ...
    /**
     * @return TokenizeRead|array The current TokenizeRead data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TokenizeRead fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TokenizeRead fields).
     */
     ...
     *
     * @param TokenizeReadCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TokenizeReadCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TokenizeRead|array The created TokenizeRead as an assoc-array at the
