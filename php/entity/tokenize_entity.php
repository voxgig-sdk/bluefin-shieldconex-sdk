...
class TokenizeEntity
{
     ...
     *
     * @param TokenizeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TokenizeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Tokenize|array The created Tokenize as an assoc-array at the
