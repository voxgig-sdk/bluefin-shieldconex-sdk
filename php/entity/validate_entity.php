...
class ValidateEntity
{
     ...
     *
     * @param ValidateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ValidateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Validate|array The created Validate as an assoc-array at the
