...
class TokenizeBatchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TokenizeBatchEntity($this->_client, $opts);
    }

    /**
     * @param TokenizeBatch|array $args TokenizeBatch data (assoc-array) to store.
     */
    ...
    /**
     * @return TokenizeBatch|array The current TokenizeBatch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TokenizeBatch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TokenizeBatch fields).
     */
     ...
     *
     * @param TokenizeBatchCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TokenizeBatchCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TokenizeBatch|array The created TokenizeBatch as an assoc-array at the
