...
// BluefinShieldconex SDK timeout feature
...
class BluefinShieldconexTimeoutFeature extends BluefinShieldconexBaseFeature
{
    ...
    private function _with_timeout(BluefinShieldconexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BluefinShieldconexContext $_ctx, float $ms): void
    {
        $client = $this->client;
