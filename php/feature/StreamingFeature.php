...
class BluefinShieldconexStreamingFeature extends BluefinShieldconexBaseFeature
{
    ...
    private function _iterate(BluefinShieldconexResult $result): \Generator
    {
    ...
    private function _streamable(BluefinShieldconexContext $ctx): bool
    {
