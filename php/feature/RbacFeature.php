...
// BluefinShieldconex SDK rbac feature
...
class BluefinShieldconexRbacFeature extends BluefinShieldconexBaseFeature
{
    ...
    private function _required(BluefinShieldconexContext $ctx): ?string
    {
    ...
    private function _reject(BluefinShieldconexContext $ctx, string $required): void
    {
    ...
    private function _track(BluefinShieldconexContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
