...
// BluefinShieldconex SDK cache feature
...
class BluefinShieldconexCacheFeature extends BluefinShieldconexBaseFeature
{
    ...
    private function _through(BluefinShieldconexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
