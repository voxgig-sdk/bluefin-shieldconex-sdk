...
class BluefinShieldconexPagingFeature extends BluefinShieldconexBaseFeature
{
    ...
    private function _graphql_pre_request(BluefinShieldconexContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(BluefinShieldconexContext $ctx): bool
    {
