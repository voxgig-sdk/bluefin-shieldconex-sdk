...
class BluefinShieldconexProxyFeature extends BluefinShieldconexBaseFeature
{
    ...
    public function init(BluefinShieldconexContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BluefinShieldconexContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
