...
class BluefinShieldconexTestFeature extends BluefinShieldconexBaseFeature
{
    ...
    public function init(BluefinShieldconexContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BluefinShieldconexContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = BluefinShieldconexParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BluefinShieldconexContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BluefinShieldconexContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = BluefinShieldconexParam::call($ctx, $k);
