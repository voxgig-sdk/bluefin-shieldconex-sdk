...
public class DetokenizeEntity extends EntityBase {

  public DetokenizeEntity(SdkClient client, Map<String, Object> entopts) {
    super("detokenize", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new DetokenizeEntity(this.client, opts);
  }
