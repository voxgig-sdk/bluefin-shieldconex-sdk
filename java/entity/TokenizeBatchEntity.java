...
public class TokenizeBatchEntity extends EntityBase {

  public TokenizeBatchEntity(SdkClient client, Map<String, Object> entopts) {
    super("tokenize_batch", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new TokenizeBatchEntity(this.client, opts);
  }
