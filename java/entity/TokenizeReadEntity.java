...
public class TokenizeReadEntity extends EntityBase {

  public TokenizeReadEntity(SdkClient client, Map<String, Object> entopts) {
    super("tokenize_read", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new TokenizeReadEntity(this.client, opts);
  }
