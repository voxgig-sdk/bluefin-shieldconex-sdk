...
public class TokenizeEntity extends EntityBase {

  public TokenizeEntity(SdkClient client, Map<String, Object> entopts) {
    super("tokenize", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new TokenizeEntity(this.client, opts);
  }
