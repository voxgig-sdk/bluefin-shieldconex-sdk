// Validate entity client (generated — mirrors the go Entity fragment).
...
impl ValidateEntity {
    pub fn new(client: &Rc<BluefinShieldconexSDK>, entopts: Value) -> Rc<ValidateEntity> {
...
impl Entity for ValidateEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ValidateEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinShieldconexEntity for ValidateEntity {
