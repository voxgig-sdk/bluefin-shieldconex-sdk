// TokenizeRead entity client (generated — mirrors the go Entity fragment).
...
impl TokenizeReadEntity {
    pub fn new(client: &Rc<BluefinShieldconexSDK>, entopts: Value) -> Rc<TokenizeReadEntity> {
        ...
        let e = Rc::new(TokenizeReadEntity {
            name: "tokenize_read".to_string(),
            client: client.clone(),
...
impl Entity for TokenizeReadEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        TokenizeReadEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinShieldconexEntity for TokenizeReadEntity {
