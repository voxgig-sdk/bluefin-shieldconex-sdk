// TokenizeBatch entity client (generated — mirrors the go Entity fragment).
...
pub struct TokenizeBatchEntity {
    name: String,
    #[allow(dead_code)]
...
impl TokenizeBatchEntity {
    pub fn new(client: &Rc<BluefinShieldconexSDK>, entopts: Value) -> Rc<TokenizeBatchEntity> {
        ...
        let e = Rc::new(TokenizeBatchEntity {
            name: "tokenize_batch".to_string(),
            client: client.clone(),
...
impl Entity for TokenizeBatchEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        TokenizeBatchEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinShieldconexEntity for TokenizeBatchEntity {
    ...
    fn list(self: &Rc<Self>, _reqmatch: Value, _ctrl: Value) -> Result<Vec<Rc<Self>>, BluefinShieldconexError> {
