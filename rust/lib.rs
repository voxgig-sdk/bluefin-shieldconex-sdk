// BluefinShieldconex SDK for Rust (generated by @voxgig/sdkgen).
//
...
pub use crate::core::error::BluefinShieldconexError;
...
pub use crate::core::sdk::{test_sdk, BluefinShieldconexSDK};
pub use crate::core::spec::Spec;
pub use crate::core::types::{
    Entity, Feature, FeatureRef, FetcherFn, OutVal, BluefinShieldconexEntity,
};
...
// No-argument convenience constructors: `bluefin_shieldconex_sdk::new()` /
// `bluefin_shieldconex_sdk::test()` for the common no-options case.
use std::rc::Rc;

pub fn new() -> Rc<BluefinShieldconexSDK> {
    BluefinShieldconexSDK::new(Value::Noval)
}

pub fn test() -> Rc<BluefinShieldconexSDK> {
