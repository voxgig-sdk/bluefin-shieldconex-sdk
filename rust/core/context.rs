...
pub struct CtxSpec {
    ...
    pub client: Option<Rc<BluefinShieldconexSDK>>,
...
pub struct Context {
    ...
    pub client: RefCell<Option<Rc<BluefinShieldconexSDK>>>,
...
impl Context {
    ...
    pub fn make_error(&self, code: &str, msg: &str) -> BluefinShieldconexError {
