// BluefinShieldconexSDK client (generated — mirrors the go Main fragment).
...
use crate::core::error::BluefinShieldconexError;
...
pub struct BluefinShieldconexSDK {
...
impl BluefinShieldconexSDK {
    pub fn new(options: Value) -> Rc<BluefinShieldconexSDK> {
        let sdk = Rc::new(BluefinShieldconexSDK {
    ...
    pub fn prepare(&self, fetchargs: Value) -> Result<Value, BluefinShieldconexError> {
    ...
    pub fn direct(&self, fetchargs: Value) -> Result<Value, BluefinShieldconexError> {
    ...
    fn op_denied(&self, op: &str) -> Value {
        ...
        jo(vec![
            ...
            ("err", Value::str(format!(
                "BluefinShieldconexSDK: {}: operation not allowed by SDK option \
    ...
    // gate by passing it.
    fn raw_request(&self, fetchargs: Value) -> Result<Value, BluefinShieldconexError> {
        let utility = &self.utility;
    ...
    pub fn graphql(
    ...
    ) -> Result<Value, BluefinShieldconexError> {
        ...
        if let Value::List(items) = &errors {
            ...
            if let Some(first) = first {
                ...
                setp(&res, "err",
                     Value::str(format!("BluefinShieldconexSDK: graphql: {}", msg)));
    ...
    pub fn detokenize(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::detokenize::DetokenizeEntity> {
        crate::entity::detokenize::DetokenizeEntity::new(self, entopts)
    }

    /// Tokenize entity bound to this client.
    pub fn tokenize(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::tokenize::TokenizeEntity> {
        crate::entity::tokenize::TokenizeEntity::new(self, entopts)
    }

    /// TokenizeBatch entity bound to this client.
    pub fn tokenize_batch(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::tokenize_batch::TokenizeBatchEntity> {
        crate::entity::tokenize_batch::TokenizeBatchEntity::new(self, entopts)
    }

    /// TokenizeRead entity bound to this client.
    pub fn tokenize_read(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::tokenize_read::TokenizeReadEntity> {
        crate::entity::tokenize_read::TokenizeReadEntity::new(self, entopts)
    }

    /// Validate entity bound to this client.
    pub fn validate(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::validate::ValidateEntity> {
        crate::entity::validate::ValidateEntity::new(self, entopts)
    }

}

pub fn test_sdk(testopts: Value, sdkopts: Value) -> Rc<BluefinShieldconexSDK> {
    ...
    let sdk = BluefinShieldconexSDK::new(sdkopts);
    *sdk.mode.borrow_mut() = "test".to_string();
