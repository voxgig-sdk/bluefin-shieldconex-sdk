...
// tm/swift/Tests/BluefinShieldconexSDKTests/OmniResolver.swift, and it follows the
...
use bluefin_shieldconex_sdk::utility::voxgigstruct::ordered_map::OrderedMap;
use bluefin_shieldconex_sdk::utility::voxgigstruct::value::Value;
use bluefin_shieldconex_sdk::utility::voxgigstruct::InjectDef;
use bluefin_shieldconex_sdk::BluefinShieldconexError;
...
pub fn vget(val: &Value, key: &str) -> Value {
    bluefin_shieldconex_sdk::utility::voxgigstruct::lookup(val, &Value::str(key))
}
