// detokenize direct API test (generated from the API model).

import XCTest

@testable import BluefinShieldconexSdk

final class DetokenizeDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let sdk = BluefinShieldconexSDK(opts)

    let args = VMap()
    args.entries["path"] = .string("/detokenize")
