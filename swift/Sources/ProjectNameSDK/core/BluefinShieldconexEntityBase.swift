// BluefinShieldconexEntityBase - shared entity behaviour: construction, data/match
...
open class BluefinShieldconexEntityBase: Entity {
  var name: String
  var client: BluefinShieldconexSDK
  var utility: Utility
  var entopts: VMap
  var data = VMap()
  var match = VMap()
  ...
  public init(_ client: BluefinShieldconexSDK, _ entoptsIn: VMap?, _ name: String) {
  ...
  open func make() -> Entity {
    return BluefinShieldconexEntityBase(client, cloneOpts(), name)
  }
