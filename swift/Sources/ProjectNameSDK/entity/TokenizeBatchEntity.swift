...
public final class TokenizeBatchEntity: BluefinShieldconexEntityBase {
  public init(_ client: BluefinShieldconexSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "tokenize_batch")
  }

  public override func make() -> Entity {
    return TokenizeBatchEntity(client, cloneOpts())
  }
