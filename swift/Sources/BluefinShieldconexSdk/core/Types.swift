// BluefinShieldconex SDK - core contracts.
...
// BluefinShieldconexEntityBase which implements this.
...
// Throws (typically BluefinShieldconexError) on transport-level failure. A returned
