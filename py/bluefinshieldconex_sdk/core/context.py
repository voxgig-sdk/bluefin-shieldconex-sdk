...
from bluefinshieldconex_sdk.core.control import BluefinShieldconexControl
...
from bluefinshieldconex_sdk.core.helpers import get_ctx_prop, to_map
...
class BluefinShieldconexContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BluefinShieldconexControl()
        ...
        if isinstance(sp, BluefinShieldconexSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BluefinShieldconexResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BluefinShieldconexResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BluefinShieldconexOperation({})
        ...
        op = BluefinShieldconexOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return BluefinShieldconexError(code, msg, self)
