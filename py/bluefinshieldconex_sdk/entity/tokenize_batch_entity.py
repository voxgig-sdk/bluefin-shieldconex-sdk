...
class TokenizeBatchEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TokenizeBatchEntity(self._client, opts)
    ...
    def data_get(self) -> TokenizeBatch:
    ...
    def match_get(self) -> TokenizeBatch:
    ...
    def create(self, reqdata: TokenizeBatchCreateData, ctrl=None) -> TokenizeBatch:
        utility = self._utility
