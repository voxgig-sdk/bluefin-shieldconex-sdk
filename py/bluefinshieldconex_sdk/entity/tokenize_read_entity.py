...
class TokenizeReadEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TokenizeReadEntity(self._client, opts)
    ...
    def data_get(self) -> TokenizeRead:
    ...
    def match_get(self) -> TokenizeRead:
    ...
    def create(self, reqdata: TokenizeReadCreateData, ctrl=None) -> TokenizeRead:
        utility = self._utility
