# BluefinShieldconex SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BluefinShieldconexSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BluefinShieldconexSDK(...) and BluefinShieldconexSDK.test(...) become
#      BluefinShieldconexSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bluefinshieldconex_sdk"
_SDK_CLASS = "BluefinShieldconexSDK"
...
_ENTITIES = {
    ...
    "Tokenize": "tokenize",
    "TokenizeBatch": "tokenize_batch",
    "TokenizeRead": "tokenize_read",
    "Validate": "validate",
}
