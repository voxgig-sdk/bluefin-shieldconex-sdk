    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set BLUEFINSHIELDCONEX_TEST_TOKENIZE_BATCH_ENTID JSON to run live")
        client = setup["client"]
        ...
        tokenize_batch_ref01_data = helpers.to_map(tokenize_batch_ref01_ent.create(tokenize_batch_ref01_data, None))
...
def _tokenize_batch_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("BLUEFINSHIELDCONEX_TEST_TOKENIZE_BATCH_ENTID"))
