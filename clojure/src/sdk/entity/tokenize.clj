;; BluefinShieldconex SDK Tokenize entity (generated by @voxgig/sdkgen).
(ns sdk.entity.tokenize
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "tokenize" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "tokenize")
...
;; Canonical facade: (Tokenize client data) accessor delegates here.
...
;; List Tokenize items matching a filter (reqmatch: any subset of fields).
...
;; Create a new Tokenize (reqdata: body data).
