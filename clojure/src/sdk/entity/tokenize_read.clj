;; BluefinShieldconex SDK TokenizeRead entity (generated by @voxgig/sdkgen).
(ns sdk.entity.tokenize_read
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "tokenize_read" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "tokenize_read")
...
;; Canonical facade: (TokenizeRead client data) accessor delegates here.
...
;; Create a new TokenizeRead (reqdata: body data).
