;; BluefinShieldconex SDK Detokenize entity (generated by @voxgig/sdkgen).
(ns sdk.entity.detokenize
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "detokenize" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "detokenize")
...
;; Canonical facade: (Detokenize client data) accessor delegates here.
...
;; List Detokenize items matching a filter (reqmatch: any subset of fields).
...
;; Create a new Detokenize (reqdata: body data).
