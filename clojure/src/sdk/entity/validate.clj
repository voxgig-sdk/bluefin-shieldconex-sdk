;; BluefinShieldconex SDK Validate entity (generated by @voxgig/sdkgen).
(ns sdk.entity.validate
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "validate" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "validate")
...
;; Canonical facade: (Validate client data) accessor delegates here.
...
;; Create a new Validate (reqdata: body data).
