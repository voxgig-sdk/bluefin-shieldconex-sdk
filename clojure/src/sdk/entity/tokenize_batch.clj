;; BluefinShieldconex SDK TokenizeBatch entity (generated by @voxgig/sdkgen).
(ns sdk.entity.tokenize_batch
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "tokenize_batch" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "tokenize_batch")
...
;; Canonical facade: (TokenizeBatch client data) accessor delegates here.
...
;; Create a new TokenizeBatch (reqdata: body data).
