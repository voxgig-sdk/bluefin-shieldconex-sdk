...
// ---- SDK client-base generic helpers (Main.fragment BluefinShieldconexSDK) -------
...
voxgig_value* sdk_options_map(BluefinShieldconexSDK* sdk) { return voxgig_clone(sdk->options); }

Utility* sdk_get_utility(BluefinShieldconexSDK* sdk) { return utility_copy(sdk->utility); }

Context* sdk_get_root_ctx(BluefinShieldconexSDK* sdk) { return sdk->rootctx; }
