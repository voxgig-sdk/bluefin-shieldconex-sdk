// BluefinShieldconex SDK — umbrella runtime header (template; BluefinShieldconex tokens
...
#ifndef BLUEFINSHIELDCONEX_SDK_H
#define BLUEFINSHIELDCONEX_SDK_H
...
typedef struct BluefinShieldconexSDK BluefinShieldconexSDK;
...
// ===========================================================================
// Error (mirrors core/error.rs BluefinShieldconexError)
// ===========================================================================

typedef struct PNError {
  char* sdk;   // "BluefinShieldconex"
...
// ===========================================================================
// Entity (vtable; mirrors core/types.rs Entity + BluefinShieldconexEntity)
// ===========================================================================
...
typedef struct EntityVT {
  ...
  // CRUD ops (BluefinShieldconexEntity). On error set *err and return NULL.
...
// ===========================================================================
// SDK client (mirrors Main.fragment BluefinShieldconexSDK) — generic fields.
// ===========================================================================

struct BluefinShieldconexSDK {
  char* mode;             // "live" | "test"
  voxgig_value* options;
  Utility* utility;
...
void sdk_features_push(BluefinShieldconexSDK* sdk, Feature* f);
void sdk_features_insert(BluefinShieldconexSDK* sdk, size_t i, Feature* f);
void sdk_features_replace(BluefinShieldconexSDK* sdk, size_t i, Feature* f);

voxgig_value* sdk_options_map(BluefinShieldconexSDK* sdk); // deep clone of options
Utility* sdk_get_utility(BluefinShieldconexSDK* sdk);      // utility_copy
Context* sdk_get_root_ctx(BluefinShieldconexSDK* sdk);

// Constructors / prepare / direct are in the generated client.c:
BluefinShieldconexSDK* bluefinshieldconex_sdk_new(voxgig_value* options);
BluefinShieldconexSDK* test_sdk(voxgig_value* testopts, voxgig_value* sdkopts);
voxgig_value* sdk_prepare(BluefinShieldconexSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_direct(BluefinShieldconexSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_graphql(BluefinShieldconexSDK* sdk, const char* query,
...
#endif // BLUEFINSHIELDCONEX_SDK_H
