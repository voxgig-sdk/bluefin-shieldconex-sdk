// Generated instance test for the tokenize_read entity.
...
int main(void) {
  ...
  Entity* e = bluefin_shieldconex_tokenize_read(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "tokenize_read", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_shieldconex_tokenize_read(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = tokenize_read_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_shieldconex_tokenize_read(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = tokenize_read_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("tokenize_read_entity");
}
