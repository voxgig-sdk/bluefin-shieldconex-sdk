...
static BluefinShieldconexSDK* C;
static Utility* U;
...
static void test_primary_fetcher_live(void) {
  ...
  BluefinShieldconexSDK* live = bluefinshieldconex_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinShieldconexSDK* blocked = bluefinshieldconex_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinShieldconexSDK* client = bluefinshieldconex_sdk_new(v_undef());
