// Minimal C test harness for the BluefinShieldconex SDK test binaries. Each test
...
#ifndef BLUEFINSHIELDCONEX_CTEST_H
#define BLUEFINSHIELDCONEX_CTEST_H
...
#endif // BLUEFINSHIELDCONEX_CTEST_H
