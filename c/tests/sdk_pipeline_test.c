...
int main(void) {
  ...
  BluefinShieldconexSDK* t = test_sdk(NULL, NULL);
  ...
  BluefinShieldconexSDK* sdk = bluefinshieldconex_sdk_new(opts);
  ...
  BluefinShieldconexSDK* rsdk = bluefinshieldconex_sdk_new(ropts);
  PNError* rerr = NULL;
