// Behavioural feature-test harness for the BluefinShieldconex SDK (C port of the
...
#ifndef BLUEFINSHIELDCONEX_FEATURE_HARNESS_H
#define BLUEFINSHIELDCONEX_FEATURE_HARNESS_H
...
#endif // BLUEFINSHIELDCONEX_FEATURE_HARNESS_H
