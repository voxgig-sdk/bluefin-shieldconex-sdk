...
int main(void) {
  ...
  Entity* e = bluefin_shieldconex_validate(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_shieldconex_validate(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = validate_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_shieldconex_validate(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = validate_stream(pe, "list", NULL, NULL, &perr);
