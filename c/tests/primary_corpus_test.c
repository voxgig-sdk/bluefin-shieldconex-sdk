...
static Context* corpus_ctx(BluefinShieldconexSDK* cl, voxgig_value* ctxmap) {
  CtxSpec cs;
...
static void runset(const char* name, BluefinShieldconexSDK* cl,
                        ctxfn cf, argfn af) {
...
static BluefinShieldconexSDK* SHARED = NULL;
...
static BluefinShieldconexSDK* client_for(const char* section) {
