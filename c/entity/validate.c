// Validate entity client (generated — mirrors the rust Entity fragment).
...
typedef struct validate_entity {
...
static const char* validate_get_name(Entity* e);
...
Entity* validate_entity_new(BluefinShieldconexSDK* client, voxgig_value* entopts) {
  ...
  validate_entity* self = (validate_entity*)calloc(1, sizeof(validate_entity));
  self->base.vt = &validate_VT;
  self->name = strdup("validate");
  self->client = client;
...
static voxgig_value* validate_run_op(validate_entity* self, Context* ctx,
                                    validate_postdone_fn post_done, PNError** err) {
...
voxgig_value* validate_stream(Entity* e, const char* action, voxgig_value* args,
...
static Entity* validate_make(Entity* e) {
  ...
  return validate_entity_new(self->client, opts);
}
...
static voxgig_value* validate_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(validate_ent_ctx(self), "SetData");
  }
  feature_hook_util(validate_ent_ctx(self), "GetData");
...
static voxgig_value* validate_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(validate_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(validate_ent_ctx(self), "GetMatch");
...
static void validate_create_postdone(validate_entity* self, Context* ctx) {
