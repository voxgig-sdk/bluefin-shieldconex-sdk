// Detokenize entity client (generated — mirrors the rust Entity fragment).
...
typedef struct detokenize_entity {
...
typedef void (*detokenize_postdone_fn)(detokenize_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT detokenize_VT;
static const char* detokenize_get_name(Entity* e);
static Entity* detokenize_make(Entity* e);
static voxgig_value* detokenize_data(Entity* e, voxgig_value* args);
static voxgig_value* detokenize_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* detokenize_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** detokenize_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* detokenize_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* detokenize_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* detokenize_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void detokenize_mark_deleted(Entity* e);
static bool detokenize_deleted(Entity* e);

static Context* detokenize_ent_ctx(detokenize_entity* self) {
  return self->entctx;
}
...
Entity* detokenize_entity_new(BluefinShieldconexSDK* client, voxgig_value* entopts) {
  ...
  detokenize_entity* self = (detokenize_entity*)calloc(1, sizeof(detokenize_entity));
  self->base.vt = &detokenize_VT;
  self->name = strdup("detokenize");
  self->client = client;
...
static voxgig_value* detokenize_run_op(detokenize_entity* self, Context* ctx,
                                    detokenize_postdone_fn post_done, PNError** err) {
...
voxgig_value* detokenize_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  detokenize_entity* self = (detokenize_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, detokenize_ent_ctx(self));
...
static const char* detokenize_get_name(Entity* e) {
  return ((detokenize_entity*)e)->name;
}
...
static Entity* detokenize_make(Entity* e) {
  ...
  return detokenize_entity_new(self->client, opts);
}
...
static voxgig_value* detokenize_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(detokenize_ent_ctx(self), "SetData");
  }
  feature_hook_util(detokenize_ent_ctx(self), "GetData");
...
static voxgig_value* detokenize_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(detokenize_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(detokenize_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static Entity* detokenize_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "detokenize");
  return NULL;
}


static void detokenize_list_postdone(detokenize_entity* self, Context* ctx) {
...
static Entity** detokenize_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, detokenize_ent_ctx(self));
  voxgig_value* out = detokenize_run_op(self, ctx, detokenize_list_postdone, err);
  if (*err) return NULL;
...
static void detokenize_create_postdone(detokenize_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
...
static Entity* detokenize_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, detokenize_ent_ctx(self));
  detokenize_run_op(self, ctx, detokenize_create_postdone, err);
  if (*err) return NULL;
...
static Entity* detokenize_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "detokenize");
  return NULL;
}

static Entity* detokenize_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "detokenize");
  return NULL;
}
...
// live record.
static void detokenize_mark_deleted(Entity* e) {
  ((detokenize_entity*)e)->deleted = true;
}

static bool detokenize_deleted(Entity* e) {
  return ((detokenize_entity*)e)->deleted;
}
