...
static voxgig_value* detokenize_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* detokenize_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* detokenize_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* detokenize_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* detokenize_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
...
static voxgig_value* detokenize_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
...
static voxgig_value* detokenize_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, detokenize_ent_ctx(self));
  return detokenize_run_op(self, ctx, detokenize_list_postdone, err);
}
...
static voxgig_value* detokenize_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, detokenize_ent_ctx(self));
  return detokenize_run_op(self, ctx, detokenize_create_postdone, err);
}


static voxgig_value* detokenize_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "detokenize");
  return NULL;
}

static voxgig_value* detokenize_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
