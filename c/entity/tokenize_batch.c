// TokenizeBatch entity client (generated — mirrors the rust Entity fragment).
...
typedef struct tokenize_batch_entity {
...
static const char* tokenize_batch_get_name(Entity* e);
...
Entity* tokenize_batch_entity_new(BluefinShieldconexSDK* client, voxgig_value* entopts) {
  ...
  tokenize_batch_entity* self = (tokenize_batch_entity*)calloc(1, sizeof(tokenize_batch_entity));
  self->base.vt = &tokenize_batch_VT;
  self->name = strdup("tokenize_batch");
  self->client = client;
...
static voxgig_value* tokenize_batch_run_op(tokenize_batch_entity* self, Context* ctx,
                                    tokenize_batch_postdone_fn post_done, PNError** err) {
...
voxgig_value* tokenize_batch_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* tokenize_batch_get_name(Entity* e) {
  return ((tokenize_batch_entity*)e)->name;
}
...
static Entity* tokenize_batch_make(Entity* e) {
  ...
  return tokenize_batch_entity_new(self->client, opts);
}
...
static voxgig_value* tokenize_batch_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(tokenize_batch_ent_ctx(self), "SetData");
  }
  feature_hook_util(tokenize_batch_ent_ctx(self), "GetData");
...
static voxgig_value* tokenize_batch_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(tokenize_batch_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(tokenize_batch_ent_ctx(self), "GetMatch");
...
static void tokenize_batch_create_postdone(tokenize_batch_entity* self, Context* ctx) {
...
static const EntityVT tokenize_batch_VT = {
  ...
  tokenize_batch_update,
  tokenize_batch_remove,
};
