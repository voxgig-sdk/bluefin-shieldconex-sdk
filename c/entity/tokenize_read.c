// TokenizeRead entity client (generated — mirrors the rust Entity fragment).
...
typedef struct tokenize_read_entity {
...
static const char* tokenize_read_get_name(Entity* e);
...
Entity* tokenize_read_entity_new(BluefinShieldconexSDK* client, voxgig_value* entopts) {
  ...
  tokenize_read_entity* self = (tokenize_read_entity*)calloc(1, sizeof(tokenize_read_entity));
  self->base.vt = &tokenize_read_VT;
  self->name = strdup("tokenize_read");
  self->client = client;
...
static voxgig_value* tokenize_read_run_op(tokenize_read_entity* self, Context* ctx,
                                    tokenize_read_postdone_fn post_done, PNError** err) {
...
voxgig_value* tokenize_read_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* tokenize_read_get_name(Entity* e) {
  return ((tokenize_read_entity*)e)->name;
}
...
static Entity* tokenize_read_make(Entity* e) {
  ...
  return tokenize_read_entity_new(self->client, opts);
}
...
static voxgig_value* tokenize_read_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(tokenize_read_ent_ctx(self), "SetData");
  }
  feature_hook_util(tokenize_read_ent_ctx(self), "GetData");
...
static voxgig_value* tokenize_read_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(tokenize_read_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(tokenize_read_ent_ctx(self), "GetMatch");
...
static void tokenize_read_create_postdone(tokenize_read_entity* self, Context* ctx) {
...
static const EntityVT tokenize_read_VT = {
  ...
  tokenize_read_update,
  tokenize_read_remove,
};
