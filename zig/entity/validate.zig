// Validate entity client (generated — mirrors the go/rust Entity fragment).
...
pub const ValidateEntity = struct {
    ...
    pub fn new(client: *sdk.BluefinShieldconexSDK, entopts_in: Value) *ValidateEntity {
        ...
        const e = h.A().create(ValidateEntity) catch unreachable;
        e.* = .{
            .name = "validate",
            .client = client,
    ...
    fn ent_ctx(self: *ValidateEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *ValidateEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *ValidateEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *ValidateEntity, ctx: *Context, post_done: *const fn (*ValidateEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *ValidateEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *ValidateEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *ValidateEntity, ctx: *Context, post_done: *const fn (*ValidateEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *ValidateEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *ValidateEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return ValidateEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *ValidateEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *ValidateEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *ValidateEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *ValidateEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *ValidateEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *ValidateEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *ValidateEntity, ctx: *Context) void {
    ...
    pub fn update(self: *ValidateEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *ValidateEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
