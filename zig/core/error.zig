// BluefinShieldconexError: the SDK error type (mirrors go core/error.go / the rust
...
pub const BluefinShieldconexError = struct {
    sdk: []const u8 = "BluefinShieldconex",
    code: []const u8,
    msg: []const u8,
    ...
    pub fn make(code: []const u8, msg: []const u8) *BluefinShieldconexError {
        const e = mem.a().create(BluefinShieldconexError) catch unreachable;
        e.* = .{ .sdk = "BluefinShieldconex", .code = code, .msg = msg };
        return e;
    }
};
