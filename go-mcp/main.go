// Command BluefinShieldconex-mcp is an MCP server exposing the BluefinShieldconex
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BluefinShieldconex_list  — list records of an entity
//	BluefinShieldconex_load  — load a single record of an entity
//
