...
type Args struct {
	Entity string         `json:"entity" jsonschema:"detokenize | tokenize | tokenize_batch | tokenize_read | validate"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BluefinShieldconexSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "bluefin-shieldconex_list",
		Description: "List records from BluefinShieldconex. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "bluefin-shieldconex_load",
		Description: "Load a single record from BluefinShieldconex. " +
...
func runOp(client *sdk.BluefinShieldconexSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BluefinShieldconexSDK, name string) (sdk.BluefinShieldconexEntity, error) {
	switch strings.ToLower(name) {
	case "detokenize":
		return client.Detokenize(nil), nil
	case "tokenize":
		return client.Tokenize(nil), nil
	case "tokenize_batch":
		return client.TokenizeBatch(nil), nil
	case "tokenize_read":
		return client.TokenizeRead(nil), nil
	case "validate":
