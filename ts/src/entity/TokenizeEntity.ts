...
class TokenizeEntity extends BluefinShieldconexEntityBase<Tokenize> {
  ...
  async create(this: any, reqdata?: TokenizeCreateData, ctrl?: Control): Promise<TokenizeEntity> {
