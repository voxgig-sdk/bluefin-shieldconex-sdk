...
(0, node_test_1.describe)('ValidateEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set BLUEFIN_SHIELDCONEX_TEST_VALIDATE_ENTID JSON to run live');
            return;
        }
        ...
        (0, node_assert_1.default)(null != validate_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['validate01', 'validate02', 'validate03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['BLUEFIN_SHIELDCONEX_TEST_VALIDATE_ENTID'];
