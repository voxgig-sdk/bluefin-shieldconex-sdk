...
(0, node_test_1.describe)('DetokenizeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BluefinShieldconexSDK({
    ...
    (0, node_test_1.test)('direct-list-detokenize', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-detokenize', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BluefinShieldconexSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.BLUEFIN_SHIELDCONEX_APIKEY,
            secret: env.BLUEFIN_SHIELDCONEX_SECRET,
        }));
        let idmap = env['BLUEFIN_SHIELDCONEX_TEST_DETOKENIZE_ENTID'];
...
//# sourceMappingURL=DetokenizeDirect.test.js.map