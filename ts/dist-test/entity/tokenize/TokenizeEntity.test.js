...
(0, node_test_1.describe)('TokenizeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set BLUEFIN_SHIELDCONEX_TEST_TOKENIZE_ENTID JSON to run live');
            return;
        }
        ...
        (0, node_assert_1.default)(null != tokenize_ref01_data);
        // LIST
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['BLUEFIN_SHIELDCONEX_TEST_TOKENIZE_ENTID'];
