...
function envOverride(m) {
    if ('TRUE' === process.env.BLUEFIN_SHIELDCONEX_TEST_LIVE ||
        'TRUE' === process.env.BLUEFIN_SHIELDCONEX_TEST_OVERRIDE) {
    ...
    m.BLUEFIN_SHIELDCONEX_TEST_EXPLAIN = process.env.BLUEFIN_SHIELDCONEX_TEST_EXPLAIN || m.BLUEFIN_SHIELDCONEX_TEST_EXPLAIN;
    return m;
}
