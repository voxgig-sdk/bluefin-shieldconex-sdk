...
describe('DetokenizeDirect', async () => {
  ...
  test('direct-list-detokenize', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-detokenize', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['BLUEFINSHIELDCONEX_TEST_DETOKENIZE_ENTID']
