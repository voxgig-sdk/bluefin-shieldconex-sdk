...
/**
 * Shared client runtime for the BluefinShieldconex SDK. The generated
 * BluefinShieldconexSDK class extends this with the API-specific entity accessors;
  ...
  fun graphql(
    ...
    if (null != errors && errors.isNotEmpty()) {
      ...
      res["err"] = SdkError("graphql_error",
        "BluefinShieldconexSDK: graphql: " + msg, null)
      res["graphql"] = errors
    }
