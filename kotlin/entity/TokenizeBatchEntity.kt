...
class TokenizeBatchEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("tokenize_batch", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return TokenizeBatchEntity(this.client, opts)
  }
