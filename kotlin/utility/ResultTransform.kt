...
fun resultBasic(ctx: Context): voxgig.bluefinshieldconexsdk.core.Result {
...
fun resultBody(ctx: Context): voxgig.bluefinshieldconexsdk.core.Result {
  val response = ctx.response
  val result = ctx.result
...
fun resultHeaders(ctx: Context): voxgig.bluefinshieldconexsdk.core.Result {
  val response = ctx.response
  val result = ctx.result
