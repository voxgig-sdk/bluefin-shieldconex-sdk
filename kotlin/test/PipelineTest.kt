...
class PipelineTest {
  ...
  private fun plClient(sdkopts: MutableMap<String, Any?>?): BluefinShieldconexSDK {
    return BluefinShieldconexSDK.testSDK(null, sdkopts)
  }

  private fun plCtx(client: BluefinShieldconexSDK, utility: Utility, ctrl: MutableMap<String, Any?>?): Context {
  ...
  private fun names(client: BluefinShieldconexSDK): String {
