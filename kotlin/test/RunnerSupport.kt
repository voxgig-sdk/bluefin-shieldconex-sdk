...
object RunnerSupport {
  ...
  fun makeCtxFromMap(ctxmapIn: MutableMap<String, Any?>?, client: BluefinShieldconexSDK?, utility: Utility?): Context {
  ...
  fun fixctx(ctx: Context?, client: BluefinShieldconexSDK?) {
