...
import voxgig.bluefinshieldconexsdk.sdktest.RunnerSupport.getSpec
import voxgig.bluefinshieldconexsdk.sdktest.RunnerSupport.loadTestSpec
import voxgig.bluefinshieldconexsdk.sdktest.RunnerSupport.makeCtxFromMap
import voxgig.bluefinshieldconexsdk.sdktest.RunnerSupport.runset
...
class PrimaryUtilityTest {
  ...
  private fun client(): BluefinShieldconexSDK = BluefinShieldconexSDK.testSDK()

  private fun makeTestCtx(client: BluefinShieldconexSDK, utility: Utility, overrides: MutableMap<String, Any?>?): Context {
  ...
  private fun makeTestFullCtx(client: BluefinShieldconexSDK, utility: Utility): Context {
  ...
  fun fetcherLive() {
    ...
    val liveClient = BluefinShieldconexSDK(
      fhMap(
        "system",
        fhMap(
          "fetch",
  ...
  fun fetcherBlockedTestMode() {
    val blockedClient = BluefinShieldconexSDK(
      fhMap(
        "system",
  ...
  fun makeSpecBasic() {
    ...
    val specClient = BluefinShieldconexSDK.testSDK(null, setupOpts)
  ...
  fun prepareAuthBasic() {
    ...
    val authClient = BluefinShieldconexSDK.testSDK(null, setupOpts)
