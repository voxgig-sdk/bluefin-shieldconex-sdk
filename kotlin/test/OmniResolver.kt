...
object OmniResolver {
  ...
  class Run internal constructor(
    ...
    val client: BluefinShieldconexSDK?,
  ) {
   ...
   */
  fun makeRunner(testfile: Any?, client: BluefinShieldconexSDK?): NamedRunner {
  ...
  private fun sdkProvider(client: BluefinShieldconexSDK?): Provider = Provider(
    ...
    client = { options ->
      ...
      sdkProvider(BluefinShieldconexSDK.testSDK(null, opts ?: linkedMapOf()))
    },
   ...
   * per section, by hand.)
   */
  fun omniCtx(arg: Any?, client: BluefinShieldconexSDK?, utility: Utility?): Context {
