...
class TokenizeEntityTest {
  ...
  fun basic() {
    ...
    tokenizeRef01Data = Helpers.toMapAny(if (tokenizeRef01DataResult is SdkEntity) tokenizeRef01DataResult.data() else tokenizeRef01DataResult) ?: linkedMapOf()
  ...
  companion object {
    fun tokenizeBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      val entidEnvRaw = RunnerSupport.getenv("BLUEFIN_SHIELDCONEX_TEST_TOKENIZE_ENTID")
      val idmapOverridden = entidEnvRaw != null && entidEnvRaw.trim().startsWith("{")

      val envm = linkedMapOf<String, Any?>()
      envm["BLUEFIN_SHIELDCONEX_TEST_TOKENIZE_ENTID"] = idmap
      ...
      var idmapResolved = Helpers.toMapAny(env["BLUEFIN_SHIELDCONEX_TEST_TOKENIZE_ENTID"])
