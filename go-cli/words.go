...
func registerSDKWords(r *eng.Registry, client *sdk.BluefinShieldconexSDK) {
...
func runOp(client *sdk.BluefinShieldconexSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
