...
type TokenizeBatchEntity struct {
	name    string
...
func NewTokenizeBatchEntity(client *core.BluefinShieldconexSDK, entopts map[string]any) *TokenizeBatchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TokenizeBatchEntity) GetName() string { return e.name }
...
func (e *TokenizeBatchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TokenizeBatchEntity) Deleted() bool {
	return e.deleted
}


func (e *TokenizeBatchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTokenizeBatchEntity(e.client, opts)
}

func (e *TokenizeBatchEntity) Data(args ...any) any {
...
func (e *TokenizeBatchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TokenizeBatch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TokenizeBatchEntity) DataTyped(data ...TokenizeBatch) TokenizeBatch {
	if len(data) > 0 {
		return typedFrom[TokenizeBatch](e.Data(asMap(data[0])))
	}
	return typedFrom[TokenizeBatch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TokenizeBatch (all fields
// optional at the wire level).
func (e *TokenizeBatchEntity) MatchTyped(match ...TokenizeBatch) TokenizeBatch {
	if len(match) > 0 {
		return typedFrom[TokenizeBatch](e.Match(asMap(match[0])))
	}
	return typedFrom[TokenizeBatch](e.Match())
}
...
func (e *TokenizeBatchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TokenizeBatchEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TokenizeBatchEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TokenizeBatchEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TokenizeBatchCreateData and returns an TokenizeBatch. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TokenizeBatchEntity) CreateTyped(reqdata TokenizeBatchCreateData, ctrl map[string]any) (TokenizeBatch, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return TokenizeBatch{}, err
	}
	return typedFrom[TokenizeBatch](res), nil
}



func (e *TokenizeBatchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TokenizeBatchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TokenizeBatchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
