...
type DetokenizeEntity struct {
	name    string
	client  *core.BluefinShieldconexSDK
...
func NewDetokenizeEntity(client *core.BluefinShieldconexSDK, entopts map[string]any) *DetokenizeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DetokenizeEntity) GetName() string { return e.name }
...
func (e *DetokenizeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DetokenizeEntity) Deleted() bool {
	return e.deleted
}


func (e *DetokenizeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDetokenizeEntity(e.client, opts)
}

func (e *DetokenizeEntity) Data(args ...any) any {
...
func (e *DetokenizeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Detokenize; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DetokenizeEntity) DataTyped(data ...Detokenize) Detokenize {
	if len(data) > 0 {
		return typedFrom[Detokenize](e.Data(asMap(data[0])))
	}
	return typedFrom[Detokenize](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Detokenize (all fields
// optional at the wire level).
func (e *DetokenizeEntity) MatchTyped(match ...Detokenize) Detokenize {
	if len(match) > 0 {
		return typedFrom[Detokenize](e.Match(asMap(match[0])))
	}
	return typedFrom[Detokenize](e.Match())
}
...
func (e *DetokenizeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DetokenizeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DetokenizeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DetokenizeListMatch and returns []Detokenize. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DetokenizeEntity) ListTyped(reqmatch DetokenizeListMatch, ctrl map[string]any) ([]Detokenize, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Detokenize](res), nil
}




func (e *DetokenizeEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// DetokenizeCreateData and returns an Detokenize. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DetokenizeEntity) CreateTyped(reqdata DetokenizeCreateData, ctrl map[string]any) (Detokenize, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Detokenize{}, err
	}
	return typedFrom[Detokenize](res), nil
}



func (e *DetokenizeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DetokenizeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DetokenizeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
