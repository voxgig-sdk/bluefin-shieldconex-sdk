...
const testSeed = `map[string]any{"entity": map[string]any{"detokenize": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tokenize": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tokenize_batch": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tokenize_read": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "validate": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
