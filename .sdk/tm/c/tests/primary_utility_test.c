...
static void test_primary_fetcher_live(void) {
  ...
  BluefinShieldconexSDK* live = projectname_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinShieldconexSDK* blocked = projectname_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinShieldconexSDK* client = projectname_sdk_new(v_undef());
