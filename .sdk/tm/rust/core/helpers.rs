// Shared Value helpers for the BluefinShieldconex SDK pipeline. The SDK data model
...
// underlying API spec doesn't define. The static BluefinShieldconexEntity trait
...
pub fn unsupported_op(opname: &str, entityname: &str) -> BluefinShieldconexError {
    BluefinShieldconexError::new(
        "unsupported_op",
        &format!(
