...
// BluefinShieldconex SDK pipeline test
//
...
{
    private static function utility(): BluefinShieldconexUtility
    {
        return new BluefinShieldconexUtility();
    }
    ...
    private static function ctx(array $over = []): BluefinShieldconexContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BluefinShieldconexContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BluefinShieldconexOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BluefinShieldconexError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BluefinShieldconexOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BluefinShieldconexMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BluefinShieldconexOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BluefinShieldconexMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BluefinShieldconexOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BluefinShieldconexMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BluefinShieldconexSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BluefinShieldconexMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BluefinShieldconexResponse([]),
            'result' => new BluefinShieldconexResult([]),
        ]);
        [, $err] = BluefinShieldconexMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BluefinShieldconexSpec([]),
            'response' => null,
            'result' => new BluefinShieldconexResult([]),
        ]);
        [, $err] = BluefinShieldconexMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BluefinShieldconexSpec(['step' => 's']),
            'response' => new BluefinShieldconexResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BluefinShieldconexResult([]),
        ]);
        [, $err] = BluefinShieldconexMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BluefinShieldconexSpec(['step' => 's']),
            'response' => new BluefinShieldconexResponse(self::resp(200, ['v' => 1])),
            'result' => new BluefinShieldconexResult([]),
        ]);
        [, $err] = BluefinShieldconexMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BluefinShieldconexSpec(['step' => 's']),
            'response' => new BluefinShieldconexResponse(self::resp(200, ['v' => 2])),
            'result' => new BluefinShieldconexResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BluefinShieldconexMakeResponse::call($ctx);
    ...
    {
        $preset = new BluefinShieldconexResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BluefinShieldconexSpec([]),
            'response' => new BluefinShieldconexResponse([]),
            'result' => new BluefinShieldconexResult([]),
        ...
        [$got, $err] = BluefinShieldconexMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BluefinShieldconexResult([])]);
        [, $err] = BluefinShieldconexMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BluefinShieldconexSpec([]), 'result' => null]);
        [, $err] = BluefinShieldconexMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BluefinShieldconexSpec(['step' => 's']),
            'result' => new BluefinShieldconexResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BluefinShieldconexOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BluefinShieldconexMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BluefinShieldconexSpec(['step' => 's']),
            'result' => new BluefinShieldconexResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BluefinShieldconexOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BluefinShieldconexMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BluefinShieldconexResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BluefinShieldconexSpec([]),
            'result' => new BluefinShieldconexResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BluefinShieldconexMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BluefinShieldconexMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BluefinShieldconexError('boom', 'boom');
        $utility->fetcher = function (BluefinShieldconexContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BluefinShieldconexSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BluefinShieldconexMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BluefinShieldconexContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BluefinShieldconexMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BluefinShieldconexResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BluefinShieldconexMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BluefinShieldconexContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BluefinShieldconexSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BluefinShieldconexMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BluefinShieldconexResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BluefinShieldconexSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BluefinShieldconexMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BluefinShieldconexMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BluefinShieldconexMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BluefinShieldconexResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BluefinShieldconexDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BluefinShieldconexResult(['ok' => false])]);
        $this->expectException(BluefinShieldconexError::class);
        BluefinShieldconexDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BluefinShieldconexResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BluefinShieldconexMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BluefinShieldconexMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BluefinShieldconexBaseFeature();
        $b = new BluefinShieldconexBaseFeature();
        BluefinShieldconexFeatureAdd::call($ctx, $a);
        BluefinShieldconexFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BluefinShieldconexBaseFeature
    {
        $f = new BluefinShieldconexBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BluefinShieldconexFeatureAdd::call($ctx, self::named_feature('a'));
        BluefinShieldconexFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        BluefinShieldconexFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        BluefinShieldconexFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        BluefinShieldconexFeatureAdd::call($ctx, $replace);
        ...
        BluefinShieldconexFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BluefinShieldconexContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BluefinShieldconexSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BluefinShieldconexPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BluefinShieldconexPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BluefinShieldconexResponse(['headers' => null]),
            'result' => new BluefinShieldconexResult([]),
        ]);
        BluefinShieldconexResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BluefinShieldconexResultBody::call($ctx);
