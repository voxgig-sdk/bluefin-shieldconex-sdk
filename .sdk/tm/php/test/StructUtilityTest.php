...
// BluefinShieldconex SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BluefinShieldconexOmni::makeStructRunner(
    ...
    {
        return BluefinShieldconexOmni::objmodel(BluefinShieldconexOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return BluefinShieldconexOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return BluefinShieldconexOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BluefinShieldconexOmni::structfix($now, Struct::undef()))
                        !== json_encode(BluefinShieldconexOmni::structfix($val, Struct::undef()))) {
