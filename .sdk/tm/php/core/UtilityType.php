...
// BluefinShieldconex SDK utility type

class BluefinShieldconexUtility
{
    ...
    public static function copy(BluefinShieldconexUtility $src): BluefinShieldconexUtility
    {
        $u = new BluefinShieldconexUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
