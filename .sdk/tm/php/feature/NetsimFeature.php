...
// BluefinShieldconex SDK netsim feature
...
class BluefinShieldconexNetsimFeature extends BluefinShieldconexBaseFeature
{
    ...
    private function _simulate(BluefinShieldconexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BluefinShieldconexContext $ctx, array $applied): void
    {
        $client = $this->client;
