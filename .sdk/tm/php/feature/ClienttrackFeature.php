...
class BluefinShieldconexClienttrackFeature extends BluefinShieldconexBaseFeature
{
    ...
    public function PostConstruct(BluefinShieldconexContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BluefinShieldconex-SDK';
