...
// BluefinShieldconex SDK ratelimit feature
...
class BluefinShieldconexRatelimitFeature extends BluefinShieldconexBaseFeature
{
    ...
    private function _acquire(BluefinShieldconexContext $ctx): void
    {
    ...
    private function _track(BluefinShieldconexContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
