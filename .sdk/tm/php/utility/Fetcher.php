...
class BluefinShieldconexFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BluefinShieldconexSDK/1.0)';
    ...
    public static function call(BluefinShieldconexContext $ctx, string $fullurl, array $fetchdef): array
    {
