...
class BluefinShieldconexGraphql
{
    ...
    // equivalent.
    public static function body(BluefinShieldconexContext $ctx): mixed
    {
    ...
    public static function errors(BluefinShieldconexContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
