...
public class PrimaryUtilityTest
{
    ...
    private static OmniResolver.Run Run()
    {
        lock (RunLock)
        {
            if (RUN == null)
            {
                CLIENT = BluefinShieldconexSDK.TestSDK(null, null);
    ...
    private static BluefinShieldconexSDK GetClient()
    {
        Run();
        return CLIENT!;
    }
    ...
    private static Context MakeTestCtx(BluefinShieldconexSDK client, Utility utility,
    ...
    private static Context MakeTestFullCtx(BluefinShieldconexSDK client, Utility utility)
    {
    ...
    {
        var hookClient = BluefinShieldconexSDK.TestSDK(null, null);
    ...
    {
        var initClient = BluefinShieldconexSDK.TestSDK(null, null);
    ...
    public void FetcherBlockedTestMode()
    {
        ...
        var blockedClient = new BluefinShieldconexSDK(new Dictionary<string, object?>
        {
            ["base"] = "http://localhost:8080",
            ["system"] = new Dictionary<string, object?>
            {
    ...
    public void MakeSpecBasic()
    {
        ...
        var specClient = BluefinShieldconexSDK.TestSDK(null, setupOpts);
    ...
    // BluefinShieldconexError. The corpus says `match: out: code` for both, so
    ...
    public void MakePointBasic()
    {
        runsection("makePoint", args =>
        {
            ...
            catch (BluefinShieldconexError e)
            {
    ...
    public void PrepareAuthBasic()
    {
        ...
        var authClient = BluefinShieldconexSDK.TestSDK(null, setupOpts);
