...
|---|---|---|
| `js/` | @voxgig-sdk/bluefin-shieldconex-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/bluefin-shieldconex | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/bluefin-shieldconex-js \
      --repository voxgig-sdk/bluefin-shieldconex-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/bluefin-shieldconex-js` shows it, and
`npm trust revoke @voxgig-sdk/bluefin-shieldconex-js --id=<id>` removes it.
