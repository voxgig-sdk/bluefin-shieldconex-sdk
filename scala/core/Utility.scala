...
class Utility private (noregister: Boolean) {
  ...
  val struct: voxgig.bluefinshieldconexsdk.utility.StructUtility.type = voxgig.bluefinshieldconexsdk.utility.StructUtility

  def this() = {
    this(false)
    voxgig.bluefinshieldconexsdk.utility.Register.registerAll(this)
  }
