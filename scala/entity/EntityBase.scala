...
import voxgig.bluefinshieldconexsdk.core.{Context, Helpers, SdkClient, SdkEntity, Utility}
import voxgig.bluefinshieldconexsdk.utility.struct.Struct

// Shared entity runtime for the BluefinShieldconex SDK: accreting data/match state,
