...
// Tokenize entity client for the BluefinShieldconex SDK.
class TokenizeEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("tokenize", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new TokenizeEntity(this.client, opts)
  }
