...
import voxgig.bluefinshieldconexsdk.core.{Context, Entity, Helpers, SdkClient}
import voxgig.bluefinshieldconexsdk.utility.struct.Struct

// TokenizeRead entity client for the BluefinShieldconex SDK.
class TokenizeReadEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("tokenize_read", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new TokenizeReadEntity(this.client, opts)
  }
