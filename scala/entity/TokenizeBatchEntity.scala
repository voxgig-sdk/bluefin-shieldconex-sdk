...
class TokenizeBatchEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("tokenize_batch", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new TokenizeBatchEntity(this.client, opts)
  }
