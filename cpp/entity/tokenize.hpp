// Tokenize entity client (generated). Shared entity runtime (data/match
...
class TokenizeEntity : public EntityBase {
public:
  TokenizeEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("tokenize", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<TokenizeEntity>(this->client, opts);
  }
