// Validate entity client (generated). Shared entity runtime (data/match
...
class ValidateEntity : public EntityBase {
public:
  ValidateEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("validate", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ValidateEntity>(this->client, opts);
  }
