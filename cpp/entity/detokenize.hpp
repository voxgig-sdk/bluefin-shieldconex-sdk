// Detokenize entity client (generated). Shared entity runtime (data/match
...
class DetokenizeEntity : public EntityBase {
public:
  DetokenizeEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("detokenize", client, entopts) {}
