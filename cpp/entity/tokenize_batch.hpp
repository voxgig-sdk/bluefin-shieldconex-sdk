// TokenizeBatch entity client (generated). Shared entity runtime (data/match
...
class TokenizeBatchEntity : public EntityBase {
public:
  TokenizeBatchEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("tokenize_batch", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<TokenizeBatchEntity>(this->client, opts);
  }
