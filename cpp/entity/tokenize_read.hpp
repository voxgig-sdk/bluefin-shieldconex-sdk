// TokenizeRead entity client (generated). Shared entity runtime (data/match
...
class TokenizeReadEntity : public EntityBase {
public:
  TokenizeReadEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("tokenize_read", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<TokenizeReadEntity>(this->client, opts);
  }
