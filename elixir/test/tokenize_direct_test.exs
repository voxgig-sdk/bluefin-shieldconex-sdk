# Tokenize direct test (offline, mock system.fetch)

defmodule BluefinShieldconex.TokenizeDirectTest do
  use ExUnit.Case
  ...
  test "should direct list tokenize" do
    canned = S.jt([S.jm(["id", "direct01"]), S.jm(["id", "direct02"])])
    sdk = mk(canned)
    res = BluefinShieldconex.direct(sdk, H.deep(%{"path" => "/tokenize", "method" => "GET", "params" => %{}}))
