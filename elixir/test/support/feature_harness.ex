...
defmodule BluefinShieldconex.FeatureHarness do
  alias Voxgig.Struct, as: S
  alias BluefinShieldconex.Helpers, as: H
  alias BluefinShieldconex.{Control, Spec, Result, Context, Features}

  # True when this SDK was generated with the named feature.
  def has_feature(name) do
    feature = S.getprop(BluefinShieldconex.Config.make_config(), "feature")
