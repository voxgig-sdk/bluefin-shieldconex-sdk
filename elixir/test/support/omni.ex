# BluefinShieldconex SDK corpus test runner: the vendored @voxgig/omni engine driven
...
# and tm/swift/Tests/BluefinShieldconexSDKTests/OmniResolver.swift.
#
...
defmodule BluefinShieldconex.Omni do
  ...
  defp sdkprovider(client) do
    utility = BluefinShieldconex.get_utility(client)
    ...
    %{
      ...
      client: fn options -> sdkprovider(BluefinShieldconex.test(nil, tostruct(options))) end,
  ...
  def errify(%BluefinShieldconex.Error{} = err) do
