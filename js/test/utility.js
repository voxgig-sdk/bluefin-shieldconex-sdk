...
function envOverride(m) {
  if (
    'TRUE' === process.env.BLUEFINSHIELDCONEX_TEST_LIVE ||
    'TRUE' === process.env.BLUEFINSHIELDCONEX_TEST_OVERRIDE
  ) {
  ...
  m.BLUEFINSHIELDCONEX_TEST_EXPLAIN = process.env.BLUEFINSHIELDCONEX_TEST_EXPLAIN || m.BLUEFINSHIELDCONEX_TEST_EXPLAIN
