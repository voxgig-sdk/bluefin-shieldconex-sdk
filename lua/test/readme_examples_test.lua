...
local SDK_MODULE = "bluefin-shieldconex_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["detokenize"] = { ["test01"] = { id = "test01" } }, ["tokenize"] = { ["test01"] = { id = "test01" } }, ["tokenize_batch"] = { ["test01"] = { id = "test01" } }, ["tokenize_read"] = { ["test01"] = { id = "test01" } }, ["validate"] = { ["test01"] = { id = "test01" } } } }'
