...
describe("DetokenizeDirect", function()
  it("should direct-list-detokenize", function()
    local setup = detokenize_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-detokenize", setup.live and "live" or "unit")
...
function detokenize_direct_setup(mockres)
