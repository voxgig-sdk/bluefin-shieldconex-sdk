...
describe("TokenizeBatchEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BLUEFIN_SHIELDCONEX_TEST_TOKENIZE_BATCH_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    tokenize_batch_ref01_data = helpers.to_map(type(tokenize_batch_ref01_data_result) == 'table' and tokenize_batch_ref01_data_result.data_get and tokenize_batch_ref01_data_result:data_get() or tokenize_batch_ref01_data_result)
...
function tokenize_batch_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BLUEFIN_SHIELDCONEX_TEST_TOKENIZE_BATCH_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["BLUEFIN_SHIELDCONEX_TEST_TOKENIZE_BATCH_ENTID"])
