...
local DetokenizeEntity = {}
DetokenizeEntity.__index = DetokenizeEntity


function DetokenizeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DetokenizeEntity)
  self._name = "detokenize"
  self._client = client
...
function DetokenizeEntity:get_name()
  return self._name
end


function DetokenizeEntity:make()
  local opts = {}
...
function DetokenizeEntity:mark_deleted()
  self._deleted = true
end


function DetokenizeEntity:deleted()
  return true == self._deleted
end


function DetokenizeEntity:data_set(args)
  if args ~= nil then
...
function DetokenizeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DetokenizeEntity:match_set(args)
  if args ~= nil then
...
function DetokenizeEntity:match_get()
...
function DetokenizeEntity:stream(action, args, callopts)
...
---@param reqmatch DetokenizeListMatch
---@param ctrl? table
---@return Detokenize[]
---@return string? err
function DetokenizeEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata DetokenizeCreateData
---@param ctrl? table
---@return Detokenize
---@return string? err
function DetokenizeEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function DetokenizeEntity:_run_op(ctx, post_done)
  local utility = self._utility
