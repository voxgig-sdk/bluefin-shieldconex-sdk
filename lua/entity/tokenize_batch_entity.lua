...
local TokenizeBatchEntity = {}
TokenizeBatchEntity.__index = TokenizeBatchEntity


function TokenizeBatchEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TokenizeBatchEntity)
  self._name = "tokenize_batch"
  self._client = client
...
function TokenizeBatchEntity:get_name()
  return self._name
end


function TokenizeBatchEntity:make()
  local opts = {}
...
function TokenizeBatchEntity:mark_deleted()
  self._deleted = true
end


function TokenizeBatchEntity:deleted()
  return true == self._deleted
end


function TokenizeBatchEntity:data_set(args)
  if args ~= nil then
...
function TokenizeBatchEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TokenizeBatchEntity:match_set(args)
  if args ~= nil then
...
function TokenizeBatchEntity:match_get()
...
function TokenizeBatchEntity:stream(action, args, callopts)
...
---@param reqdata TokenizeBatchCreateData
---@param ctrl? table
---@return TokenizeBatch
---@return string? err
function TokenizeBatchEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function TokenizeBatchEntity:_run_op(ctx, post_done)
  local utility = self._utility
