...
class TokenizeBatchEntity
  ...
  def make
    opts = @_entopts.dup
    TokenizeBatchEntity.new(@_client, opts)
  end
  ...
  # @return [TokenizeBatch, Hash] the current TokenizeBatch data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TokenizeBatch fields)
  def match_get
  ...
  #
  # @param reqdata [TokenizeBatchCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [TokenizeBatch, Hash] the created TokenizeBatch; raises BluefinShieldconexError on failure
