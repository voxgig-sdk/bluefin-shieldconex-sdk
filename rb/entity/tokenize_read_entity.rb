...
class TokenizeReadEntity
  ...
  def make
    opts = @_entopts.dup
    TokenizeReadEntity.new(@_client, opts)
  end
  ...
  # @return [TokenizeRead, Hash] the current TokenizeRead data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TokenizeRead fields)
  def match_get
  ...
  #
  # @param reqdata [TokenizeReadCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [TokenizeRead, Hash] the created TokenizeRead; raises BluefinShieldconexError on failure
