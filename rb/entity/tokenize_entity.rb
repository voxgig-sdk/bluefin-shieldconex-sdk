...
class TokenizeEntity
  ...
  # @return [Array<Tokenize>, Array] the matching Tokenize items; raises BluefinShieldconexError on failure
  ...
  #
  # @param reqdata [TokenizeCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Tokenize, Hash] the created Tokenize; raises BluefinShieldconexError on failure
