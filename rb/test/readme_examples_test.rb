...
#      offline in seeded test mode (BluefinShieldconexSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BluefinShieldconex_sdk.rb")
  SDK_CLASS = "BluefinShieldconexSDK"
  ...
  SDK_BASE = "BluefinShieldconex_sdk"
