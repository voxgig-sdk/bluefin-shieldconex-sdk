...
class DetokenizeEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BLUEFINSHIELDCONEX_TEST_DETOKENIZE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def detokenize_basic_setup(extra)
  ...
  entid_env_raw = ENV["BLUEFINSHIELDCONEX_TEST_DETOKENIZE_ENTID"]
